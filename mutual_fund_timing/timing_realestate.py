...
copper_future_1['zscore'] = (copper_future_1['房地产业']  - copper_future_1['房地产业'].rolling(5).mean())/copper_future_1['房地产业'].rolling(5).std(ddof=0)
...
for i in range(len(copper_future_1)):
    ...
    if copper_future_1['zscore'][i-1]>=0.4:
        copper_future_1['trade'][i:i+1]=1


print (copper_future_1)
copper_future_1['full_return'] = copper_future_1['trade']*copper_future_3['房地产业']
