...
#获取单日全部股票数据
df = pro.shibor(start_date='20190101', end_date='20241211')
df = df.iloc[::-1]
...
copper_future_1['gap'] = (df['on'].pct_change())
...
for i in range(len(copper_future_2)):
    ...
    if copper_future_2['zscore'][i-1]<=-0.6 and copper_future_2['zscore'][i-1]>=-2.:
        copper_future_2['trade'][i:i+1]=-1
    

    elif copper_future_2['zscore'][i-1]>=0.6 and copper_future_2['zscore'][i-1]<=2.:
        copper_future_2['trade'][i:i+1]=1
