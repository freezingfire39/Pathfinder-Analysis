...
for i in range(len(df_trade)):
    ...
    if df_trade['zscore_3'][i-1]<=-0. and df_trade['zscore_3'][i-1]>=-0.7:
        df_trade['trade'][i:i+1]=1

    elif df_trade['zscore_3'][i-1]>=0. and df_trade['zscore_3'][i-1]<=0.7:
        df_trade['trade'][i:i+1]=-1


    if df_trade['zscore_3'][i-1]>=0.7:
        df_trade['trade'][i:i+1]=1

    elif df_trade['zscore_3'][i-1]<=-0.7:
        df_trade['trade'][i:i+1]=-1
