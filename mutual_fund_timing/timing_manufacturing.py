...
copper_future_1['zscore'] = (copper_future_1['制造业']  - copper_future_1['制造业'].rolling(5).mean())/copper_future_1['制造业'].rolling(5).std(ddof=0)
...
print (copper_future_1)
copper_future_1['full_return'] = copper_future_1['trade']*copper_future_3['制造业']
