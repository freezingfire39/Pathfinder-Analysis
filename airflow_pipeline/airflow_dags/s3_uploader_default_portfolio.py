...
dag = DAG(
    's3_uploader_default_portfolio', default_args=default_args,
...
python_op_2 = BashOperator(
    task_id='upload_default_portfolio',
    trigger_rule='all_success',
    # bash_command='cd /home/app/Desktop/Pathfinder-Analysis/EastMoney_Scraper/scripts && python funds.eastmoney.py'
    bash_command='python /home/app/Desktop/Pathfinder-Analysis/airflow_pipeline/s3_operator/defaultPortfolioUploader.py /home/app/Desktop/default_portfolio'
)
