...
dag = DAG(
    's3_uploader_china', default_args=default_args,
...
python_op_2 = BashOperator(
    task_id='upload_funds.eastmoney',
    trigger_rule='all_success',
    # bash_command='cd /home/app/Desktop/Pathfinder-Analysis/EastMoney_Scraper/scripts && python funds.eastmoney.py'
    bash_command='python /home/app/Desktop/Pathfinder-Analysis/airflow_pipeline/s3_operator/mutalFundChinaUploader.py /home/app/Desktop/output_china'
)
