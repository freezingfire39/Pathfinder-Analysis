...
def main(symbol_file_path,symbol,search_file_path):
    ...
    df_target = Analysis_class.max_drawdown_analysis(df_target,rank_file_path = rank_file_path, input_file_path = symbol_file_path,rank_file_path = rank_file_path,security_code = Ticker)
