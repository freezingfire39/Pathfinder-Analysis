...
stock_list=[]
rank_csv_1 = pd.read_csv(input_path+'bond_drawdown_duration_rank.csv').set_index('Unnamed: 0')
...
df.to_csv(output_path+"bond_return_drawdown_duration.csv", sep=',',index=False)
