...
comp_1_name,comp_2_name, df_target = Analysis_class.corr_analysis(df_target,industry_comps,Ticker)

comp_3_name,comp_4_name, df_target = Analysis_class.corr_analysis(df_target,index_comps,Ticker)
